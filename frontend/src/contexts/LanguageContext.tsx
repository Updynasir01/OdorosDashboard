...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'indicators.vegetation-preview': 'Vegetation Index (NDVI)',
    'indicators.soil-moisture': 'Soil Moisture',
    'indicators.evapotranspiration': 'Evapotranspiration',
  ...
  so: {
    ...
    'indicators.vegetation-preview': 'Tilmaamaha Dhirta (NDVI)',
    'indicators.soil-moisture': 'Qoyaanka Ciidda',
    'indicators.evapotranspiration': 'Dhalaalka Dhalada',
