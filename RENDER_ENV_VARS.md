...
2. **CORS_ORIGIN** - Update this AFTER you deploy frontend to Vercel (replace `your-frontend.vercel.app` with actual URL)
...
3. Click "Add Environment Variable" for each:
   ...
   - Key: `CORS_ORIGIN`, Value: `https://your-frontend.vercel.app` (update later)
